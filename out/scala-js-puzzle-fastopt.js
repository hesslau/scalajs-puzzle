...
ScalaJS.is.Lgames_puzzle_geometry_Drawable = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Drawable)))
});
ScalaJS.as.Lgames_puzzle_geometry_Drawable = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Drawable(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Drawable"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Drawable = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Drawable)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Drawable = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Drawable(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Drawable;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Drawable = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Drawable: 0
}, true, "games.puzzle.geometry.Drawable", (void 0), {
  Lgames_puzzle_geometry_Drawable: 1
});
...
ScalaJS.is.Lgames_puzzle_geometry_Tile = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Tile)))
});
ScalaJS.as.Lgames_puzzle_geometry_Tile = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Tile(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Tile"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Tile = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Tile)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Tile = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Tile(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Tile;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Tile = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Tile: 0
}, true, "games.puzzle.geometry.Tile", (void 0), {
  Lgames_puzzle_geometry_Tile: 1,
  Lgames_puzzle_geometry_Drawable: 1
});
/** @constructor */
...
ScalaJS.s.sc_IndexedSeqOptimized$class__forall__sc_IndexedSeqOptimized__F1__Z = (function($$this, p) {
  return (ScalaJS.s.sc_IndexedSeqOptimized$class__prefixLengthImpl__p0__sc_IndexedSeqOptimized__F1__Z__I($$this, p, true) === $$this.length__I())
});
ScalaJS.s.sc_IndexedSeqOptimized$class__find__sc_IndexedSeqOptimized__F1__s_Option = (function($$this, p) {
...
ScalaJS.s.sc_IndexedSeqOptimized$class__zip__sc_IndexedSeqOptimized__sc_GenIterable__scg_CanBuildFrom__O = (function($$this, that, bf) {
  if (ScalaJS.is.sc_IndexedSeq(that)) {
    ...
    while ((i < len)) {
      b.$$plus$eq__O__scm_Builder(new ScalaJS.c.T2().init___O__O($$this.apply__I__O(i), x2.apply__I__O(i)));
      i = ((1 + i) | 0)
    };
    return b.result__O()
  } else {
    return ScalaJS.s.sc_IterableLike$class__zip__sc_IterableLike__sc_GenIterable__scg_CanBuildFrom__O($$this, that, bf)
  }
});
...
ScalaJS.s.sc_IndexedSeqOptimized$class__zipWithIndex__sc_IndexedSeqOptimized__scg_CanBuildFrom__O = (function($$this, bf) {
  var b = bf.apply__O__scm_Builder($$this.repr__O());
  var len = $$this.length__I();
  b.sizeHint__I__V(len);
  var i = 0;
  while ((i < len)) {
    b.$$plus$eq__O__scm_Builder(new ScalaJS.c.T2().init___O__O($$this.apply__I__O(i), i));
    i = ((1 + i) | 0)
  };
  return b.result__O()
});
...
ScalaJS.s.sc_IterableLike$class__zip__sc_IterableLike__sc_GenIterable__scg_CanBuildFrom__O = (function($$this, that, bf) {
  var b = bf.apply__O__scm_Builder($$this.repr__O());
  var these = $$this.iterator__sc_Iterator();
  var those = that.iterator__sc_Iterator();
  while ((these.hasNext__Z() && those.hasNext__Z())) {
    b.$$plus$eq__O__scm_Builder(new ScalaJS.c.T2().init___O__O(these.next__O(), those.next__O()))
  };
  return b.result__O()
});
...
ScalaJS.s.sc_IterableLike$class__zipWithIndex__sc_IterableLike__scg_CanBuildFrom__O = (function($$this, bf) {
  var b = bf.apply__O__scm_Builder($$this.repr__O());
  var i = new ScalaJS.c.sr_IntRef().init___I(0);
  $$this.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, b$1, i$1) {
    return (function(x$2) {
      b$1.$$plus$eq__O__scm_Builder(new ScalaJS.c.T2().init___O__O(x$2, i$1.elem$1));
...
ScalaJS.s.sc_Iterator$class__find__sc_Iterator__F1__s_Option = (function($$this, p) {
...
ScalaJS.s.sc_LinearSeqOptimized$class__forall__sc_LinearSeqOptimized__F1__Z = (function($$this, p) {
  var these = $$this;
...
ScalaJS.s.sc_LinearSeqOptimized$class__find__sc_LinearSeqOptimized__F1__s_Option = (function($$this, p) {
  var these = $$this;
  while ((!these.isEmpty__Z())) {
    if (ScalaJS.uZ(p.apply__O__O(these.head__O()))) {
...
ScalaJS.s.scm_ResizableArray$class__update__scm_ResizableArray__I__O__V = (function($$this, idx, elem) {
  if ((idx >= $$this.size0$6)) {
...
/** @constructor */
ScalaJS.c.Lgames_puzzle_Game$ = (function() {
  ScalaJS.c.O.call(this);
  this.canvas$1 = null;
  this.ctx$1 = null;
  this.image$1 = null;
...
ScalaJS.c.Lgames_puzzle_Game$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lgames_puzzle_Game$.prototype.constructor = ScalaJS.c.Lgames_puzzle_Game$;
/** @constructor */
ScalaJS.h.Lgames_puzzle_Game$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_Game$.prototype = ScalaJS.c.Lgames_puzzle_Game$.prototype;
ScalaJS.c.Lgames_puzzle_Game$.prototype.init___ = (function() {
  ScalaJS.n.Lgames_puzzle_Game$ = this;
  this.canvas$1 = this.createCanvasElement__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement();
  this.ctx$1 = this.get2DContext__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D(this.canvas$1);
  this.image$1 = this.createImageElement__p1__Lgames_puzzle_geometry_Image();
  this.image$1["src"] = "image.png";
  this.puzzle$1 = new ScalaJS.c.Lgames_puzzle_geometry_Puzzle().init___Lgames_puzzle_geometry_Image__I__I__Lgames_puzzle_geometry_Position(this.image$1, 50, 4, new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(2, 0));
  ScalaJS.g["document"]["onkeydown"] = (function(e$2) {
    var x1 = ScalaJS.uI(e$2["keyCode"]);
    switch (x1) {
      case 65:
        /*<skip>*/;
      case 37:
        {
          ScalaJS.m.Lgames_puzzle_Game$().moveLeft__V();
          ScalaJS.m.Lgames_puzzle_Game$().reDraw__V();
          return (void 0);
          break
        };
      case 68:
      ...
      case 39:
        {
          ScalaJS.m.Lgames_puzzle_Game$().moveRight__V();
          ScalaJS.m.Lgames_puzzle_Game$().reDraw__V();
          return (void 0);
          break
        };
      ...
      case 38:
        {
          ScalaJS.m.Lgames_puzzle_Game$().moveUp__V();
          ScalaJS.m.Lgames_puzzle_Game$().reDraw__V();
          return (void 0);
          break
        };
      ...
      case 40:
        {
          ScalaJS.m.Lgames_puzzle_Game$().moveDown__V();
          ScalaJS.m.Lgames_puzzle_Game$().reDraw__V();
          return (void 0);
          break
        };
      case 81:
        {
          ScalaJS.m.Lgames_puzzle_Game$().puzzle$1.shuffle__V();
          ScalaJS.m.Lgames_puzzle_Game$().reDraw__V();
          return (void 0);
          break
        };
      default:
        return ScalaJS.m.Lgames_puzzle_Game$().games$puzzle$Game$$log__O__O((("Key " + x1) + " not found."));
    }
  });
  return this
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.moveLeft__V = (function() {
  this.puzzle$1.emptyTile__Lgames_puzzle_geometry_EmptyTile().moveRight__V()
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.createImageElement__p1__Lgames_puzzle_geometry_Image = (function() {
  return ScalaJS.g["document"]["createElement"]("img")
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.reDraw__V = (function() {
  this.ctx$1["clearRect"](0.0, 0.0, ScalaJS.uI(this.canvas$1["width"]), ScalaJS.uI(this.canvas$1["height"]));
  this.drawIt__Lgames_puzzle_geometry_Drawable__V(this.puzzle$1);
  if (this.puzzle$1.isSolved__Z()) {
    var this$2 = ScalaJS.m.s_Console$();
    var this$3 = this$2.outVar$2;
    ScalaJS.as.Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V("Puzzle solved!")
  }
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.createCanvasElement__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement = (function() {
  return ScalaJS.g["document"]["createElement"]("canvas")
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.main__V = (function() {
  this.image$1["onload"] = (function(e$2) {
    ScalaJS.m.Lgames_puzzle_Game$().startGame__V()
  })
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.$$js$exported$prop$startGame__O = (function() {
  this.startGame__V()
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.drawIt__Lgames_puzzle_geometry_Drawable__V = (function(d) {
  d.at__Lgames_puzzle_geometry_Position__F1(new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(0, 0)).apply__O__O(this.ctx$1)
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.moveUp__V = (function() {
  this.puzzle$1.emptyTile__Lgames_puzzle_geometry_EmptyTile().moveDown__V()
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.addToBody__p1__Lorg_scalajs_dom_raw_HTMLElement__V = (function(element) {
  ScalaJS.g["document"]["body"]["appendChild"](element)
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.startGame__V = (function() {
  this.games$puzzle$Game$$log__O__O("Starting Game");
  this.canvas$1["width"] = 300;
  this.canvas$1["height"] = 300;
  this.addToBody__p1__Lorg_scalajs_dom_raw_HTMLElement__V(this.canvas$1);
  this.reDraw__V()
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.moveRight__V = (function() {
  this.puzzle$1.emptyTile__Lgames_puzzle_geometry_EmptyTile().moveLeft__V()
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.games$puzzle$Game$$log__O__O = (function(x) {
  var this$2 = ScalaJS.m.s_Console$();
  var this$3 = this$2.outVar$2;
  ScalaJS.as.Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V(x);
  return x
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.get2DContext__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D = (function(c) {
  return c["getContext"]("2d")
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.moveDown__V = (function() {
  this.puzzle$1.emptyTile__Lgames_puzzle_geometry_EmptyTile().moveUp__V()
});
Object["defineProperty"](ScalaJS.c.Lgames_puzzle_Game$.prototype, "startGame", {
  "get": (function() {
    return this.$$js$exported$prop$startGame__O()
  }),
  "enumerable": true
});
ScalaJS.c.Lgames_puzzle_Game$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.is.Lgames_puzzle_Game$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_Game$)))
});
ScalaJS.as.Lgames_puzzle_Game$ = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_Game$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.Game$"))
});
ScalaJS.isArrayOf.Lgames_puzzle_Game$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_Game$)))
});
ScalaJS.asArrayOf.Lgames_puzzle_Game$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_Game$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.Game$;", depth))
});
ScalaJS.d.Lgames_puzzle_Game$ = new ScalaJS.ClassTypeData({
  Lgames_puzzle_Game$: 0
}, false, "games.puzzle.Game$", ScalaJS.d.O, {
  Lgames_puzzle_Game$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
ScalaJS.c.Lgames_puzzle_Game$.prototype.$classData = ScalaJS.d.Lgames_puzzle_Game$;
ScalaJS.n.Lgames_puzzle_Game$ = (void 0);
ScalaJS.m.Lgames_puzzle_Game$ = (function() {
  if ((!ScalaJS.n.Lgames_puzzle_Game$)) {
    ScalaJS.n.Lgames_puzzle_Game$ = new ScalaJS.c.Lgames_puzzle_Game$().init___()
  };
  return ScalaJS.n.Lgames_puzzle_Game$
});
ScalaJS.e["games"] = (ScalaJS.e["games"] || {});
ScalaJS.e["games"]["puzzle"] = (ScalaJS.e["games"]["puzzle"] || {});
ScalaJS.e["games"]["puzzle"]["Game"] = ScalaJS.m.Lgames_puzzle_Game$;
...
ScalaJS.c.ju_Random.prototype.next__I__I = (function(bits) {
  this.seed$1 = new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(4194303, 4194303, 15).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(11, 0, 0).$$plus__sjsr_RuntimeLong__sjsr_RuntimeLong(new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(2942573, 6011, 0).$$times__sjsr_RuntimeLong__sjsr_RuntimeLong(this.seed$1)));
...
ScalaJS.c.ju_Random.prototype.setSeed__J__V = (function(seed_in) {
  this.seed$1 = new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(4194303, 4194303, 15).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(new ScalaJS.c.sjsr_RuntimeLong().init___I__I__I(2942573, 6011, 0).$$up__sjsr_RuntimeLong__sjsr_RuntimeLong(seed_in));
  this.haveNextNextGaussian$1 = false
});
...
ScalaJS.c.sc_TraversableLike$WithFilter.prototype.map__F1__scg_CanBuildFrom__O = (function(f, bf) {
  ...
  this.$$outer$f.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, f$1, b$1) {
    return (function(x$2) {
      return (ScalaJS.uZ(this$2.p$1.apply__O__O(x$2)) ? b$1.$$plus$eq__O__scm_Builder(f$1.apply__O__O(x$2)) : (void 0))
    })
  })(this, f, b)));
  return b.result__O()
});
...
ScalaJS.c.s_util_Random.prototype.swap$1__p1__I__I__scm_ArrayBuffer__V = (function(i1, i2, buf$1) {
  var tmp = ScalaJS.s.scm_ResizableArray$class__apply__scm_ResizableArray__I__O(buf$1, i1);
  var elem = ScalaJS.s.scm_ResizableArray$class__apply__scm_ResizableArray__I__O(buf$1, i2);
  ScalaJS.s.scm_ResizableArray$class__update__scm_ResizableArray__I__O__V(buf$1, i1, elem);
  ScalaJS.s.scm_ResizableArray$class__update__scm_ResizableArray__I__O__V(buf$1, i2, tmp)
});
ScalaJS.c.s_util_Random.prototype.shuffle__sc_TraversableOnce__scg_CanBuildFrom__sc_TraversableOnce = (function(xs, bf) {
  var buf = new ScalaJS.c.scm_ArrayBuffer().init___().$$plus$plus$eq__sc_TraversableOnce__scm_ArrayBuffer(xs);
  var $$this = buf.size0$6;
  var isEmpty$4 = ($$this > 2);
  var numRangeElements$4 = (isEmpty$4 ? 0 : (($$this < (-2147483644)) ? (-1) : ((3 - $$this) | 0)));
  var lastElement$4 = (isEmpty$4 ? (((-1) + $$this) | 0) : 2);
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  var isEmpty$4$1 = ($$this < 2);
  var numRangeElements$4$1 = (isEmpty$4$1 ? 0 : (((-1) + $$this) | 0));
  var lastElement$4$1 = (isEmpty$4$1 ? ((1 + $$this) | 0) : 2);
  var terminalElement$4$1 = (((-1) + lastElement$4$1) | 0);
  if ((numRangeElements$4$1 < 0)) {
    ScalaJS.m.sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$($$this, 2, (-1), true)
  };
  var i = $$this;
  var count = 0;
  ...
  return ScalaJS.as.sc_TraversableOnce(ScalaJS.as.scm_Builder(bf.apply__O__scm_Builder(xs).$$plus$plus$eq__sc_TraversableOnce__scg_Growable(buf)).result__O())
});
...
ScalaJS.c.sci_Stream$StreamWithFilter.prototype.tailMap$1__p2__sci_Stream__F1__sci_Stream = (function(coll, f$3) {
  ...
  while (true) {
    ...
    if (ScalaJS.uZ(this.p$2.apply__O__O(head))) {
      ...
      var tl = new ScalaJS.c.sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2, f$3$1, tail$1) {
        return (function() {
          return this$2.tailMap$1__p2__sci_Stream__F1__sci_Stream(ScalaJS.as.sci_Stream(tail$1.elem$1), f$3$1)
        })
      })(this, f$3, tail));
      return new ScalaJS.c.sci_Stream$Cons().init___O__F0(hd, tl)
    }
...
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1 = (function() {
  ScalaJS.c.sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype = new ScalaJS.h.sr_AbstractFunction1();
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_Puzzle$$anonfun$1 = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype = ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype;
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype.apply__O__O = (function(v1) {
  return this.apply__I__sci_IndexedSeq(ScalaJS.uI(v1))
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype.apply__I__sci_IndexedSeq = (function(x) {
  var end = (((-1) + this.$$outer$2.puzzleSize$1) | 0);
  var isEmpty$4 = (end < 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : ((end > 2147483646) ? (-1) : ((1 + end) | 0)));
  var lastElement$4 = (isEmpty$4 ? (-1) : end);
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6;
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sci_Vector$();
  var b = new ScalaJS.c.sci_VectorBuilder().init___();
  ...
  while ((i !== terminalElement$4)) {
    var arg1 = i;
    var pos = new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(x, arg1);
    var elem = new ScalaJS.c.T2().init___O__O(arg1, pos);
  ...
  ScalaJS.m.sci_IndexedSeq$();
  var bf$1 = ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6;
  var b$1 = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$8, bf$1);
  var this$9 = this$8.iterator__sci_VectorIterator();
  while (this$9.$$undhasNext$2) {
    var arg1$1 = this$9.next__O();
    var x$1 = ScalaJS.as.T2(arg1$1);
    if ((x$1 !== null)) {
      var pos$1 = ScalaJS.as.Lgames_puzzle_geometry_Position(x$1.$$und2$f);
      var x$2 = this.$$outer$2.emptyTilePos$1;
      if (((pos$1 === null) ? (x$2 === null) : pos$1.equals__O__Z(x$2))) {
        var jsx$1 = this.$$outer$2.emptyTile__Lgames_puzzle_geometry_EmptyTile()
      } else {
        var jsx$1 = new ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile().init___Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Puzzle(pos$1, this.$$outer$2)
      }
    } else {
      var jsx$1;
      throw new ScalaJS.c.s_MatchError().init___O(x$1)
    };
    b$1.$$plus$eq__O__scm_Builder(jsx$1)
  };
  return ScalaJS.as.sci_IndexedSeq(b$1.result__O())
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype.init___Lgames_puzzle_geometry_Puzzle = (function($$outer) {
  if (($$outer === null)) {
    throw ScalaJS.m.sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
ScalaJS.is.Lgames_puzzle_geometry_Puzzle$$anonfun$1 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Puzzle$$anonfun$1)))
});
ScalaJS.as.Lgames_puzzle_geometry_Puzzle$$anonfun$1 = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Puzzle$$anonfun$1(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Puzzle$$anonfun$1"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$1 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Puzzle$$anonfun$1)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$1 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$1(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Puzzle$$anonfun$1;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Puzzle$$anonfun$1 = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Puzzle$$anonfun$1: 0
}, false, "games.puzzle.geometry.Puzzle$$anonfun$1", ScalaJS.d.sr_AbstractFunction1, {
  Lgames_puzzle_geometry_Puzzle$$anonfun$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_Puzzle$$anonfun$1;
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2 = (function() {
  ScalaJS.c.sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.p$4$f = null
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype = new ScalaJS.h.sr_AbstractFunction1();
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2 = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype = ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype;
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype.apply__O__O = (function(v1) {
  this.apply__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(v1)
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype.apply__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(context) {
  this.$$outer$2.tiles$1.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, context$1) {
    return (function(t$2) {
      var t = ScalaJS.as.Lgames_puzzle_geometry_Drawable(t$2);
      t.at__Lgames_puzzle_geometry_Position__F1(arg$outer.p$4$f).apply__O__O(context$1)
    })
  })(this, context)))
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype.init___Lgames_puzzle_geometry_Puzzle__Lgames_puzzle_geometry_Position = (function($$outer, p$4) {
  if (($$outer === null)) {
    throw ScalaJS.m.sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
ScalaJS.is.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2)))
});
ScalaJS.as.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2 = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Puzzle$$anonfun$at$2"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Puzzle$$anonfun$at$2;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2 = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Puzzle$$anonfun$at$2: 0
}, false, "games.puzzle.geometry.Puzzle$$anonfun$at$2", ScalaJS.d.sr_AbstractFunction1, {
  Lgames_puzzle_geometry_Puzzle$$anonfun$at$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2;
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3 = (function() {
  ScalaJS.c.sr_AbstractFunction1.call(this);
  this.range$1$2 = null
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype = new ScalaJS.h.sr_AbstractFunction1();
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3 = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype = ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype;
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype.apply__O__O = (function(v1) {
  return this.apply__T2__sc_Seq(ScalaJS.as.T2(v1))
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype.apply__T2__sc_Seq = (function(x$5) {
  if ((x$5 !== null)) {
    var i = ScalaJS.uI(x$5.$$und1$f);
    var index = ScalaJS.uI(x$5.$$und2$f);
    var jsx$2 = ScalaJS.as.sc_TraversableLike(ScalaJS.as.sc_TraversableLike(this.range$1$2.drop__I__O(((1 + index) | 0))).filter__F1__O(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(x$4$2) {
      var x$4 = ScalaJS.uI(x$4$2);
      return (x$4 !== 0)
    })))).withFilter__F1__scg_FilterMonadic(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(i$1) {
      return (function(j$2) {
        var j = ScalaJS.uI(j$2);
        return (i$1 > j)
      })
    })(i)));
    var jsx$1 = new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(j$2$1) {
      ScalaJS.uI(j$2$1);
      return 1
    }));
    var this$1 = ScalaJS.m.sc_Seq$();
    return ScalaJS.as.sc_Seq(jsx$2.map__F1__scg_CanBuildFrom__O(jsx$1, this$1.ReusableCBFInstance$2))
  } else {
    throw new ScalaJS.c.s_MatchError().init___O(x$5)
  }
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype.init___Lgames_puzzle_geometry_Puzzle__sc_Seq = (function($$outer, range$1) {
  this.range$1$2 = range$1;
  return this
});
ScalaJS.is.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3)))
});
ScalaJS.as.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3 = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Puzzle$$anonfun$inversions$1$3"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Puzzle$$anonfun$inversions$1$3;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3 = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3: 0
}, false, "games.puzzle.geometry.Puzzle$$anonfun$inversions$1$3", ScalaJS.d.sr_AbstractFunction1, {
  Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3;
/** @constructor */
...
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_Puzzle = (function() {
  ScalaJS.c.O.call(this);
  this.image$1 = null;
  this.tileSize$1 = 0;
  this.puzzleSize$1 = 0;
  this.emptyTilePos$1 = null;
  this.emptyTile$1 = null;
  this.tiles$1 = null;
  this.bitmap$0$1 = false
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype = new ScalaJS.h.O();
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_Puzzle;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_Puzzle = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_Puzzle.prototype = ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype;
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.productPrefix__T = (function() {
  return "Puzzle"
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.productArity__I = (function() {
  return 4
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.init___Lgames_puzzle_geometry_Image__I__I__Lgames_puzzle_geometry_Position = (function(image, tileSize, puzzleSize, emptyTilePos) {
  this.image$1 = image;
  this.tileSize$1 = tileSize;
  this.puzzleSize$1 = puzzleSize;
  this.emptyTilePos$1 = emptyTilePos;
  var end = (((-1) + puzzleSize) | 0);
  var isEmpty$4 = (end < 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : ((end > 2147483646) ? (-1) : ((1 + end) | 0)));
  var lastElement$4 = (isEmpty$4 ? (-1) : end);
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  var f = new ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$1().init___Lgames_puzzle_geometry_Puzzle(this);
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6;
  ScalaJS.m.sci_IndexedSeq$();
  ScalaJS.m.sci_Vector$();
  ...
  while ((i !== terminalElement$4)) {
    var arg1 = i;
    var xs = ScalaJS.as.sc_GenTraversableOnce(f.apply__I__sci_IndexedSeq(arg1)).seq__sc_TraversableOnce();
    ScalaJS.as.sci_VectorBuilder(ScalaJS.s.scg_Growable$class__$$plus$plus$eq__scg_Growable__sc_TraversableOnce__scg_Growable(b, xs));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  this.tiles$1 = b.result__sci_Vector();
  return this
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Lgames_puzzle_geometry_Puzzle(x$1)) {
    var Puzzle$1 = ScalaJS.as.Lgames_puzzle_geometry_Puzzle(x$1);
    if (((ScalaJS.m.sr_BoxesRunTime$().equals__O__O__Z(this.image$1, Puzzle$1.image$1) && (this.tileSize$1 === Puzzle$1.tileSize$1)) && (this.puzzleSize$1 === Puzzle$1.puzzleSize$1))) {
      var x = this.emptyTilePos$1;
      var x$2 = Puzzle$1.emptyTilePos$1;
      return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
    } else {
      return false
    }
...
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.tileAt__Lgames_puzzle_geometry_Position__s_Option = (function(p) {
  return this.tiles$1.find__F1__s_Option(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(p$5) {
    return (function(t$2) {
      var t = ScalaJS.as.Lgames_puzzle_geometry_Tile(t$2);
      var x = t.current__Lgames_puzzle_geometry_Position();
      return ((x === null) ? (p$5 === null) : x.equals__O__Z(p$5))
    })
  })(p)))
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.image$1;
    ...
    case 2:
      {
        return this.puzzleSize$1;
        break
      };
    case 3:
      {
        return this.emptyTilePos$1;
        break
      };
    default:
      throw new ScalaJS.c.jl_IndexOutOfBoundsException().init___T(("" + x$1));
...
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.emptyTile__Lgames_puzzle_geometry_EmptyTile = (function() {
  return ((!this.bitmap$0$1) ? this.emptyTile$lzycompute__p1__Lgames_puzzle_geometry_EmptyTile() : this.emptyTile$1)
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.isSolved__Z = (function() {
  return this.tiles$1.forall__F1__Z(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(t$2) {
    var t = ScalaJS.as.Lgames_puzzle_geometry_Tile(t$2);
    var x = t.current__Lgames_puzzle_geometry_Position();
    var x$2 = t.origin__Lgames_puzzle_geometry_Position();
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  })))
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.at__Lgames_puzzle_geometry_Position__F1 = (function(p) {
  return new ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$at$2().init___Lgames_puzzle_geometry_Puzzle__Lgames_puzzle_geometry_Position(this, p)
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.getSolvableSeq__p1__sc_Seq = (function() {
  _getSolvableSeq: while (true) {
    var randomSeq = ScalaJS.as.sci_IndexedSeq(ScalaJS.m.s_util_Random$().shuffle__sc_TraversableOnce__scg_CanBuildFrom__sc_TraversableOnce(new ScalaJS.c.sci_Range$Inclusive().init___I__I__I(0, 8, 1), (ScalaJS.m.sci_IndexedSeq$(), ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6)));
    if (this.isSolvable$1__p1__sc_Seq__Z(randomSeq)) {
      var x = ("Order: " + randomSeq);
      ...
      continue _getSolvableSeq
    }
  }
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.isSolvable$1__p1__sc_Seq__Z = (function(range) {
  return ((this.inversions$1__p1__sc_Seq__I(range) % 2) !== 0)
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.emptyTile$lzycompute__p1__Lgames_puzzle_geometry_EmptyTile = (function() {
  if ((!this.bitmap$0$1)) {
    this.emptyTile$1 = new ScalaJS.c.Lgames_puzzle_geometry_EmptyTile().init___Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Puzzle(this.emptyTilePos$1, this);
    this.bitmap$0$1 = true
  };
  return this.emptyTile$1
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.shuffle__V = (function() {
  var end = (((-1) + this.puzzleSize$1) | 0);
  var isEmpty$4 = (end < 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : ((end > 2147483646) ? (-1) : ((1 + end) | 0)));
  var lastElement$4 = (isEmpty$4 ? (-1) : end);
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  ...
  while ((i !== terminalElement$4)) {
    var arg1 = i;
    var end$1 = (((-1) + this.puzzleSize$1) | 0);
    var this$11 = new ScalaJS.c.sci_Range$Inclusive().init___I__I__I(0, end$1, 1);
    ScalaJS.m.sci_IndexedSeq$();
    var bf$1 = ScalaJS.m.sc_IndexedSeq$().ReusableCBF$6;
    var b$1 = ScalaJS.s.sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$11, bf$1);
    ...
    var i$1 = this$11.start$4;
    var count$1 = 0;
    var terminal = this$11.terminalElement$4;
    var step = this$11.step$4;
    while ((isCommonCase ? (i$1 !== terminal) : (count$1 < this$11.numRangeElements$4))) {
      var arg1$1 = i$1;
      b$1.$$plus$eq__O__scm_Builder(new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(arg1, arg1$1));
      count$1 = ((1 + count$1) | 0);
      i$1 = ((i$1 + step) | 0)
    };
    var xs = ScalaJS.as.sc_GenTraversableOnce(ScalaJS.as.sci_IndexedSeq(b$1.result__O())).seq__sc_TraversableOnce();
    ScalaJS.as.sci_VectorBuilder(ScalaJS.s.scg_Growable$class__$$plus$plus$eq__scg_Growable__sc_TraversableOnce__scg_Growable(b, xs));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  var positions = b.result__sci_Vector();
  var jsx$2 = this.tiles$1;
  var jsx$1 = this.getSolvableSeq__p1__sc_Seq();
  var this$12 = ScalaJS.m.sc_Seq$();
  ScalaJS.as.sc_TraversableLike(jsx$2.zip__sc_GenIterable__scg_CanBuildFrom__O(jsx$1, this$12.ReusableCBFInstance$2)).withFilter__F1__scg_FilterMonadic(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(check$ifrefutable$1$2) {
    var check$ifrefutable$1 = ScalaJS.as.T2(check$ifrefutable$1$2);
    return (check$ifrefutable$1 !== null)
  }))).foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(positions$1) {
    return (function(x$2$2) {
      var x$2 = ScalaJS.as.T2(x$2$2);
      if ((x$2 !== null)) {
        var tile = ScalaJS.as.Lgames_puzzle_geometry_Tile(x$2.$$und1$f);
        var random = ScalaJS.uI(x$2.$$und2$f);
        tile.current$und$eq__Lgames_puzzle_geometry_Position__V(ScalaJS.as.Lgames_puzzle_geometry_Position(positions$1.apply__I__O(random)))
      } else {
...
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, ScalaJS.m.sr_Statics$().anyHash__O__I(this.image$1));
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.tileSize$1);
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.puzzleSize$1);
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, ScalaJS.m.sr_Statics$().anyHash__O__I(this.emptyTilePos$1));
  return ScalaJS.m.sr_Statics$().finalizeHash__I__I__I(acc, 4)
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.inversions$1__p1__sc_Seq__I = (function(range) {
  var jsx$3 = ScalaJS.as.sc_IterableLike(range.filter__F1__O(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(x$3$2) {
    var x$3 = ScalaJS.uI(x$3$2);
    return (x$3 !== 0)
  }))));
  var this$1 = ScalaJS.m.sc_Seq$();
  var jsx$2 = ScalaJS.as.sc_TraversableLike(jsx$3.zipWithIndex__scg_CanBuildFrom__O(this$1.ReusableCBFInstance$2)).withFilter__F1__scg_FilterMonadic(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(check$ifrefutable$2$2) {
    var check$ifrefutable$2 = ScalaJS.as.T2(check$ifrefutable$2$2);
    return (check$ifrefutable$2 !== null)
  })));
  var jsx$1 = new ScalaJS.c.Lgames_puzzle_geometry_Puzzle$$anonfun$inversions$1$3().init___Lgames_puzzle_geometry_Puzzle__sc_Seq(this, range);
  var this$2 = ScalaJS.m.sc_Seq$();
  return ScalaJS.as.sc_SeqLike(jsx$2.flatMap__F1__scg_CanBuildFrom__O(jsx$1, this$2.ReusableCBFInstance$2)).length__I()
});
ScalaJS.is.Lgames_puzzle_geometry_Puzzle = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Puzzle)))
});
ScalaJS.as.Lgames_puzzle_geometry_Puzzle = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Puzzle(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Puzzle"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Puzzle)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Puzzle = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Puzzle(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Puzzle;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Puzzle = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Puzzle: 0
}, false, "games.puzzle.geometry.Puzzle", ScalaJS.d.O, {
  Lgames_puzzle_geometry_Puzzle: 1,
  O: 1,
  Lgames_puzzle_geometry_Drawable: 1,
  s_Product: 1,
  s_Equals: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_Puzzle.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_Puzzle;
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_Square = (function() {
  ScalaJS.c.O.call(this);
  this.size$1 = 0
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype = new ScalaJS.h.O();
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_Square;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_Square = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_Square.prototype = ScalaJS.c.Lgames_puzzle_geometry_Square.prototype;
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.productPrefix__T = (function() {
  return "Square"
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.productArity__I = (function() {
  return 1
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Lgames_puzzle_geometry_Square(x$1)) {
    var Square$1 = ScalaJS.as.Lgames_puzzle_geometry_Square(x$1);
    return (this.size$1 === Square$1.size$1)
  } else {
    return false
  }
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.size$1;
...
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.at__Lgames_puzzle_geometry_Position__F1 = (function(p) {
  return new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, p$1) {
    return (function(context$2) {
      context$2["beginPath"]();
      context$2["moveTo"](p$1.x$1, p$1.y$1);
      context$2["lineTo"](((p$1.x$1 + arg$outer.size$1) | 0), p$1.y$1);
      context$2["lineTo"](((p$1.x$1 + arg$outer.size$1) | 0), ((p$1.y$1 + arg$outer.size$1) | 0));
      context$2["lineTo"](p$1.x$1, ((p$1.y$1 + arg$outer.size$1) | 0));
      context$2["lineTo"](p$1.x$1, p$1.y$1);
      context$2["stroke"]()
    })
  })(this, p))
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.init___I = (function(size) {
  this.size$1 = size;
  return this
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = ScalaJS.m.sr_Statics$().mix__I__I__I(acc, this.size$1);
  return ScalaJS.m.sr_Statics$().finalizeHash__I__I__I(acc, 1)
});
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.is.Lgames_puzzle_geometry_Square = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Square)))
});
ScalaJS.as.Lgames_puzzle_geometry_Square = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Square(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Square"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Square = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Square)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Square = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Square(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Square;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Square = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Square: 0
}, false, "games.puzzle.geometry.Square", ScalaJS.d.O, {
  Lgames_puzzle_geometry_Square: 1,
  O: 1,
  Lgames_puzzle_geometry_Drawable: 1,
  s_Product: 1,
  s_Equals: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_Square.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_Square;
/** @constructor */
...
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile = (function() {
  ScalaJS.c.O.call(this);
  this.origin$1 = null;
  this.puzzle$1 = null;
...
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype = new ScalaJS.h.O();
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_EmptyTile;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_EmptyTile = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_EmptyTile.prototype = ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype;
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.productPrefix__T = (function() {
  return "EmptyTile"
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.moveLeft__V = (function() {
  this.moveTo__Lgames_puzzle_geometry_Position__V(this.current$1.left__Lgames_puzzle_geometry_Position())
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.productArity__I = (function() {
  return 2
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Lgames_puzzle_geometry_EmptyTile(x$1)) {
    var EmptyTile$1 = ScalaJS.as.Lgames_puzzle_geometry_EmptyTile(x$1);
    var x = this.origin$1;
    var x$2 = EmptyTile$1.origin$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.puzzle$1;
      var x$4 = EmptyTile$1.puzzle$1;
...
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
...
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.swapWith__Lgames_puzzle_geometry_Tile__V = (function(that) {
  var thatCurrent = that.current__Lgames_puzzle_geometry_Position();
  that.current$und$eq__Lgames_puzzle_geometry_Position__V(this.current$1);
  this.current$1 = thatCurrent
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.at__Lgames_puzzle_geometry_Position__F1 = (function(p) {
  return new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, p$2) {
    return (function(context$2) {
      new ScalaJS.c.Lgames_puzzle_geometry_Square().init___I(arg$outer.puzzle$1.tileSize$1).at__Lgames_puzzle_geometry_Position__F1(p$2.$$plus__Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Position(arg$outer.current$1.$$times__I__Lgames_puzzle_geometry_Position(arg$outer.puzzle$1.tileSize$1))).apply__O__O(context$2)
    })
  })(this, p))
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.moveTo__Lgames_puzzle_geometry_Position__V = (function(p) {
  var x1 = this.puzzle$1.tileAt__Lgames_puzzle_geometry_Position__s_Option(p);
  if (ScalaJS.is.s_Some(x1)) {
    var x2 = ScalaJS.as.s_Some(x1);
    var tile = ScalaJS.as.Lgames_puzzle_geometry_Tile(x2.x$2);
    this.swapWith__Lgames_puzzle_geometry_Tile__V(tile)
  } else {
    var x = ScalaJS.m.s_None$();
    if ((x === x1)) {
      var x$1 = ("Illegal Move. No Tile at " + p);
      var this$2 = ScalaJS.m.s_Console$();
      var this$3 = this$2.outVar$2;
      ScalaJS.as.Ljava_io_PrintStream(this$3.tl$1.get__O()).println__O__V(x$1)
    } else {
      throw new ScalaJS.c.s_MatchError().init___O(x1)
    }
  }
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.moveUp__V = (function() {
  this.moveTo__Lgames_puzzle_geometry_Position__V(this.current$1.above__Lgames_puzzle_geometry_Position())
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.moveRight__V = (function() {
  this.moveTo__Lgames_puzzle_geometry_Position__V(this.current$1.right__Lgames_puzzle_geometry_Position())
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.origin__Lgames_puzzle_geometry_Position = (function() {
  return this.origin$1
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.hashCode__I = (function() {
  var this$2 = ScalaJS.m.s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.current__Lgames_puzzle_geometry_Position = (function() {
  return this.current$1
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.current$und$eq__Lgames_puzzle_geometry_Position__V = (function(x$1) {
  this.current$1 = x$1
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.moveDown__V = (function() {
  this.moveTo__Lgames_puzzle_geometry_Position__V(this.current$1.below__Lgames_puzzle_geometry_Position())
});
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.init___Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Puzzle = (function(origin, puzzle) {
  this.origin$1 = origin;
  this.puzzle$1 = puzzle;
  this.isEmpty$1 = true;
  this.current$1 = origin;
  var x = this.current$1;
  this.original$1 = (((x === null) ? (origin === null) : x.equals__O__Z(origin)) ? this : new ScalaJS.c.Lgames_puzzle_geometry_EmptyTile().init___Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Puzzle(origin, puzzle));
  return this
});
ScalaJS.is.Lgames_puzzle_geometry_EmptyTile = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_EmptyTile)))
});
ScalaJS.as.Lgames_puzzle_geometry_EmptyTile = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_EmptyTile(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.EmptyTile"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_EmptyTile = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_EmptyTile)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_EmptyTile = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_EmptyTile(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.EmptyTile;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_EmptyTile = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_EmptyTile: 0
}, false, "games.puzzle.geometry.EmptyTile", ScalaJS.d.O, {
  Lgames_puzzle_geometry_EmptyTile: 1,
  O: 1,
  Lgames_puzzle_geometry_Tile: 1,
  Lgames_puzzle_geometry_Drawable: 1,
  s_Product: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_EmptyTile.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_EmptyTile;
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile = (function() {
  ScalaJS.c.O.call(this);
  this.origin$1 = null;
  this.puzzle$1 = null;
  this.isEmpty$1 = false;
...
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype = new ScalaJS.h.O();
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_NonEmptyTile = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_NonEmptyTile.prototype = ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype;
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.productPrefix__T = (function() {
  return "NonEmptyTile"
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.productArity__I = (function() {
  return 2
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Lgames_puzzle_geometry_NonEmptyTile(x$1)) {
    var NonEmptyTile$1 = ScalaJS.as.Lgames_puzzle_geometry_NonEmptyTile(x$1);
    var x = this.origin$1;
    var x$2 = NonEmptyTile$1.origin$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.puzzle$1;
      var x$4 = NonEmptyTile$1.puzzle$1;
      return ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      return false
    }
...
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.origin$1;
...
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.at__Lgames_puzzle_geometry_Position__F1 = (function(p) {
  return new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, p$6) {
    return (function(context$2) {
      context$2["drawImage"](arg$outer.puzzle$1.image$1, ScalaJS.imul(arg$outer.origin$1.x$1, arg$outer.puzzle$1.tileSize$1), ScalaJS.imul(arg$outer.origin$1.y$1, arg$outer.puzzle$1.tileSize$1), arg$outer.puzzle$1.tileSize$1, arg$outer.puzzle$1.tileSize$1, ((ScalaJS.imul(arg$outer.current$1.x$1, arg$outer.puzzle$1.tileSize$1) + p$6.x$1) | 0), ((ScalaJS.imul(arg$outer.current$1.y$1, arg$outer.puzzle$1.tileSize$1) + p$6.y$1) | 0), arg$outer.puzzle$1.tileSize$1, arg$outer.puzzle$1.tileSize$1)
    })
  })(this, p))
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.origin__Lgames_puzzle_geometry_Position = (function() {
  return this.origin$1
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.hashCode__I = (function() {
  var this$2 = ScalaJS.m.s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.current__Lgames_puzzle_geometry_Position = (function() {
  return this.current$1
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.current$und$eq__Lgames_puzzle_geometry_Position__V = (function(x$1) {
  this.current$1 = x$1
});
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.init___Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Puzzle = (function(origin, puzzle) {
  this.origin$1 = origin;
  this.puzzle$1 = puzzle;
  this.isEmpty$1 = false;
  this.current$1 = origin;
  var x = this.current$1;
  this.original$1 = (((x === null) ? (origin === null) : x.equals__O__Z(origin)) ? this : new ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile().init___Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Puzzle(origin, puzzle));
  return this
});
ScalaJS.is.Lgames_puzzle_geometry_NonEmptyTile = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_NonEmptyTile)))
});
ScalaJS.as.Lgames_puzzle_geometry_NonEmptyTile = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_NonEmptyTile(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.NonEmptyTile"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_NonEmptyTile = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_NonEmptyTile)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_NonEmptyTile = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_NonEmptyTile(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.NonEmptyTile;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_NonEmptyTile = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_NonEmptyTile: 0
}, false, "games.puzzle.geometry.NonEmptyTile", ScalaJS.d.O, {
  Lgames_puzzle_geometry_NonEmptyTile: 1,
  O: 1,
  Lgames_puzzle_geometry_Tile: 1,
  Lgames_puzzle_geometry_Drawable: 1,
  s_Product: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_NonEmptyTile.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_NonEmptyTile;
/** @constructor */
ScalaJS.c.Lgames_puzzle_geometry_Position = (function() {
  ScalaJS.c.O.call(this);
  this.x$1 = 0;
  this.y$1 = 0
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype = new ScalaJS.h.O();
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.constructor = ScalaJS.c.Lgames_puzzle_geometry_Position;
/** @constructor */
ScalaJS.h.Lgames_puzzle_geometry_Position = (function() {
  /*<skip>*/
});
ScalaJS.h.Lgames_puzzle_geometry_Position.prototype = ScalaJS.c.Lgames_puzzle_geometry_Position.prototype;
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.$$plus__Lgames_puzzle_geometry_Position__Lgames_puzzle_geometry_Position = (function(p) {
  return new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(((p.x$1 + this.x$1) | 0), ((p.y$1 + this.y$1) | 0))
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.right__Lgames_puzzle_geometry_Position = (function() {
  return new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(((1 + this.x$1) | 0), this.y$1)
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.productPrefix__T = (function() {
  return "Position"
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.productArity__I = (function() {
  return 2
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Lgames_puzzle_geometry_Position(x$1)) {
    var Position$1 = ScalaJS.as.Lgames_puzzle_geometry_Position(x$1);
    return ((this.x$1 === Position$1.x$1) && (this.y$1 === Position$1.y$1))
  } else {
    return false
  }
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.x$1;
...
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.above__Lgames_puzzle_geometry_Position = (function() {
  return new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(this.x$1, (((-1) + this.y$1) | 0))
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.below__Lgames_puzzle_geometry_Position = (function() {
  return new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(this.x$1, ((1 + this.y$1) | 0))
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.left__Lgames_puzzle_geometry_Position = (function() {
  return new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I((((-1) + this.x$1) | 0), this.y$1)
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.$$times__I__Lgames_puzzle_geometry_Position = (function(scale) {
  return new ScalaJS.c.Lgames_puzzle_geometry_Position().init___I__I(ScalaJS.imul(this.x$1, scale), ScalaJS.imul(this.y$1, scale))
});
ScalaJS.is.Lgames_puzzle_geometry_Position = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgames_puzzle_geometry_Position)))
});
ScalaJS.as.Lgames_puzzle_geometry_Position = (function(obj) {
  return ((ScalaJS.is.Lgames_puzzle_geometry_Position(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "games.puzzle.geometry.Position"))
});
ScalaJS.isArrayOf.Lgames_puzzle_geometry_Position = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgames_puzzle_geometry_Position)))
});
ScalaJS.asArrayOf.Lgames_puzzle_geometry_Position = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lgames_puzzle_geometry_Position(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lgames.puzzle.geometry.Position;", depth))
});
ScalaJS.d.Lgames_puzzle_geometry_Position = new ScalaJS.ClassTypeData({
  Lgames_puzzle_geometry_Position: 0
}, false, "games.puzzle.geometry.Position", ScalaJS.d.O, {
  Lgames_puzzle_geometry_Position: 1,
  O: 1,
  s_math_Ordered: 1,
  jl_Comparable: 1,
  s_Product: 1,
...
ScalaJS.c.Lgames_puzzle_geometry_Position.prototype.$classData = ScalaJS.d.Lgames_puzzle_geometry_Position;
/** @constructor */
...
ScalaJS.is.sc_GenIterable = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sc_GenIterable)))
});
ScalaJS.as.sc_GenIterable = (function(obj) {
  return ((ScalaJS.is.sc_GenIterable(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.collection.GenIterable"))
});
ScalaJS.isArrayOf.sc_GenIterable = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sc_GenIterable)))
});
ScalaJS.asArrayOf.sc_GenIterable = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sc_GenIterable(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.collection.GenIterable;", depth))
});
ScalaJS.d.sc_GenIterable = new ScalaJS.ClassTypeData({
  sc_GenIterable: 0
}, true, "scala.collection.GenIterable", (void 0), {
  sc_GenIterable: 1,
...
ScalaJS.d.sc_IterableLike = new ScalaJS.ClassTypeData({
  sc_IterableLike: 0
}, true, "scala.collection.IterableLike", (void 0), {
  sc_IterableLike: 1,
  s_Equals: 1,
  sc_TraversableLike: 1,
  scg_HasNewBuilder: 1,
...
ScalaJS.c.sci_Stream$.prototype.from__I__I__sci_Stream = (function(start, step) {
  var tl = new ScalaJS.c.sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2, start$1, step$1) {
    return (function() {
      return this$2.from__I__I__sci_Stream(((start$1 + step$1) | 0), step$1)
    })
  })(this, start, step));
  return new ScalaJS.c.sci_Stream$Cons().init___O__F0(start, tl)
});
...
ScalaJS.c.sc_AbstractIterable.prototype.find__F1__s_Option = (function(p) {
  var this$1 = this.iterator__sc_Iterator();
  return ScalaJS.s.sc_Iterator$class__find__sc_Iterator__F1__s_Option(this$1, p)
});
ScalaJS.c.sc_AbstractIterable.prototype.zipWithIndex__scg_CanBuildFrom__O = (function(bf) {
  return ScalaJS.s.sc_IterableLike$class__zipWithIndex__sc_IterableLike__scg_CanBuildFrom__O(this, bf)
});
...
ScalaJS.c.sc_AbstractIterable.prototype.zip__sc_GenIterable__scg_CanBuildFrom__O = (function(that, bf) {
  return ScalaJS.s.sc_IterableLike$class__zip__sc_IterableLike__sc_GenIterable__scg_CanBuildFrom__O(this, that, bf)
});
...
ScalaJS.c.sci_StringOps.prototype.flatMap__F1__scg_CanBuildFrom__O = (function(f, bf) {
  return ScalaJS.s.sc_TraversableLike$class__flatMap__sc_TraversableLike__F1__scg_CanBuildFrom__O(this, f, bf)
});
...
ScalaJS.c.sci_StringOps.prototype.zipWithIndex__scg_CanBuildFrom__O = (function(bf) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__zipWithIndex__sc_IndexedSeqOptimized__scg_CanBuildFrom__O(this, bf)
});
...
ScalaJS.c.sci_StringOps.prototype.map__F1__scg_CanBuildFrom__O = (function(f, bf) {
  return ScalaJS.s.sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(this, f, bf)
});
...
ScalaJS.c.sc_AbstractSet.prototype.map__F1__scg_CanBuildFrom__O = (function(f, bf) {
  return ScalaJS.s.sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(this, f, bf)
});
...
ScalaJS.d.sci_IndexedSeq = new ScalaJS.ClassTypeData({
  sci_IndexedSeq: 0
}, true, "scala.collection.immutable.IndexedSeq", (void 0), {
  sci_IndexedSeq: 1,
  sci_Seq: 1,
  sci_Iterable: 1,
  sci_Traversable: 1,
...
ScalaJS.c.sci_HashSet.prototype.filter__F1__sci_HashSet = (function(p) {
...
ScalaJS.c.sci_HashSet.prototype.filter__F1__O = (function(p) {
...
ScalaJS.c.sci_List.prototype.forall__F1__Z = (function(p) {
  return ScalaJS.s.sc_LinearSeqOptimized$class__forall__sc_LinearSeqOptimized__F1__Z(this, p)
});
...
ScalaJS.c.sci_List.prototype.find__F1__s_Option = (function(p) {
  return ScalaJS.s.sc_LinearSeqOptimized$class__find__sc_LinearSeqOptimized__F1__s_Option(this, p)
});
...
ScalaJS.c.sci_Stream.prototype.zip__sc_GenIterable__scg_CanBuildFrom__O = (function(that, bf) {
  if (ScalaJS.is.sci_Stream$StreamBuilder(bf.apply__O__scm_Builder(this))) {
    if ((this.isEmpty__Z() || that.isEmpty__Z())) {
      ...
      var hd = new ScalaJS.c.T2().init___O__O(this.head__O(), that.head__O());
      var tl = new ScalaJS.c.sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2, that$1) {
        return (function() {
          var x = ScalaJS.as.sci_Stream(this$2.tail__O()).zip__sc_GenIterable__scg_CanBuildFrom__O(ScalaJS.as.sc_GenIterable(that$1.tail__O()), (ScalaJS.m.sci_Stream$(), new ScalaJS.c.sci_Stream$StreamCanBuildFrom().init___()));
          return ScalaJS.as.sci_Stream(x)
        })
      })(this, that));
      var x$1 = new ScalaJS.c.sci_Stream$Cons().init___O__F0(hd, tl)
...
ScalaJS.c.sci_WrappedString.prototype.forall__F1__Z = (function(p) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__forall__sc_IndexedSeqOptimized__F1__Z(this, p)
});
...
ScalaJS.c.sci_WrappedString.prototype.find__F1__s_Option = (function(p) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__find__sc_IndexedSeqOptimized__F1__s_Option(this, p)
});
...
ScalaJS.c.sci_WrappedString.prototype.zip__sc_GenIterable__scg_CanBuildFrom__O = (function(that, bf) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__zip__sc_IndexedSeqOptimized__sc_GenIterable__scg_CanBuildFrom__O(this, that, bf)
});
ScalaJS.is.sci_WrappedString = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sci_WrappedString)))
});
...
ScalaJS.c.scm_ListBuffer.prototype.forall__F1__Z = (function(p) {
  var this$1 = this.scala$collection$mutable$ListBuffer$$start$6;
  return ScalaJS.s.sc_LinearSeqOptimized$class__forall__sc_LinearSeqOptimized__F1__Z(this$1, p)
});
...
ScalaJS.c.scm_ListBuffer.prototype.find__F1__s_Option = (function(p) {
  var this$1 = this.scala$collection$mutable$ListBuffer$$start$6;
  return ScalaJS.s.sc_LinearSeqOptimized$class__find__sc_LinearSeqOptimized__F1__s_Option(this$1, p)
});
...
ScalaJS.c.scm_StringBuilder.prototype.zipWithIndex__scg_CanBuildFrom__O = (function(bf) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__zipWithIndex__sc_IndexedSeqOptimized__scg_CanBuildFrom__O(this, bf)
});
...
ScalaJS.c.scm_StringBuilder.prototype.zip__sc_GenIterable__scg_CanBuildFrom__O = (function(that, bf) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__zip__sc_IndexedSeqOptimized__sc_GenIterable__scg_CanBuildFrom__O(this, that, bf)
});
ScalaJS.is.scm_StringBuilder = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scm_StringBuilder)))
...
ScalaJS.c.sjs_js_WrappedArray.prototype.zip__sc_GenIterable__scg_CanBuildFrom__O = (function(that, bf) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__zip__sc_IndexedSeqOptimized__sc_GenIterable__scg_CanBuildFrom__O(this, that, bf)
});
ScalaJS.is.sjs_js_WrappedArray = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sjs_js_WrappedArray)))
...
ScalaJS.c.scm_ArrayBuffer.prototype.zip__sc_GenIterable__scg_CanBuildFrom__O = (function(that, bf) {
  return ScalaJS.s.sc_IndexedSeqOptimized$class__zip__sc_IndexedSeqOptimized__sc_GenIterable__scg_CanBuildFrom__O(this, that, bf)
});
ScalaJS.is.scm_ArrayBuffer = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scm_ArrayBuffer)))
...
ScalaJS.c.scm_ArrayBuffer.prototype.$classData = ScalaJS.d.scm_ArrayBuffer;
//# sourceMappingURL=scala-js-puzzle-fastopt.js.map
